...
gro = "NP_dfpc.gro"
xtc = "dfpc_JANUS_2.xtc"
skip = 40 # interval to sample frames from the input trajectory/ies
...
nprocs = 1 # number of stupidly parallel processors to use
...
def compute_p2s(group):
    ...
    for res in resids:
        ...
        GL1_crd = GL1.positions[0]
        GL2_crd = GL2.positions[0]
        C4A_crd = C4A.positions[0]
        C4B_crd = C4B.positions[0]
...
def analyze_clusters(frame):
    ...
    lpd1_up_coords = lpd1i_up.positions
    lpd2_up_coords = lpd2i_up.positions

    lpd1_down_coords = lpd1i_down.positions
    lpd2_down_coords = lpd2i_down.positions
