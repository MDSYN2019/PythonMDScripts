...
# ST atoms
STAtoms = universe.select_atoms("name C1")
...
BeadDict = {'C1' : 'C1', 'C2' : 'C2', 'C3' : 'C3', 'C4' : 'C4'} # Dict to store name and type of the MARTINI beads used for making the CG NP
BeadMass = {'C1' : 30.0, 'C2' : 30.0, 'C3' : 30.0, 'C4' : 30.0} # Dict to store name and mass of the MARTINI beads used for making the CG NP 
...
for index, atom in enumerate(STAtomsPositionArray):
		distarray = (distance_array(atom, P5AtomsPositionArray))
		print (STID[index], P5ID[np.argmin(distarray)], 1, np.amin(distarray)/10, 5000) # Explanation required 		
...
for res in PETAtoms.residues:
	...
	print (ligandResIDS[2], ligandResIDS[3], ligandResIDS[1], 1, 120, 25)
	print (ligandResIDS[3], ligandResIDS[1], ligandResIDS[2], 1, 120, 25)
