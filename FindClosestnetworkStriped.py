...
for res in SAtoms.residues:
	...
	print (ligandResIDS[1], ligandResIDS[2], 1, 0.14000, 392459.2) # Which bond?
	print (ligandResIDS[2], ligandResIDS[3], 1, 0.14000, 392459.2) # Which bond?
	print (ligandResIDS[3], ligandResIDS[4], 1, 0.14000, 392459.2) # Which bond?
	print (ligandResIDS[4], ligandResIDS[1], 1, 0.14000, 392459.2) # Which bond?
...
for res in SAtoms.residues:
	...
	print (ligandResIDS[2], ligandResIDS[3], ligandResIDS[4], 1, 120, 25)
	print (ligandResIDS[4], ligandResIDS[3], ligandResIDS[1], 1, 120, 25)
	ligandRes = res.resname
